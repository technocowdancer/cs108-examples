...
from .views import DeleteStatusMessageView, ShowAllProfilesView, ShowNewsFeedView, ShowProfilePageView, CreateProfileView, UpdateProfileView, post_status_message
